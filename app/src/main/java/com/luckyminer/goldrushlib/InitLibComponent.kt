package com.luckyminer.goldrushlib
...
class InitLibComponent(private var firstActivity: Activity, private var secondActivity: Activity, private var content: String?) {
    fun init(s: String){
